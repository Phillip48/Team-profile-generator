...
// 2 function should have: do you want to build an intern or engineer or quit (add employee)
function addEmployee() {

}
// 3 function If quit (writeHtml)
function writeFile() {
    
}
// array for each object make html card. append to string. call fucntion in template literal and have all the cards
